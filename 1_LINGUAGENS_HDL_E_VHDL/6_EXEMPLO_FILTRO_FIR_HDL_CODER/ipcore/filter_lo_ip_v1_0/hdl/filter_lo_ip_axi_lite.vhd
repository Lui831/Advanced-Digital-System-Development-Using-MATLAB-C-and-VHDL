-- -------------------------------------------------------------
-- 
-- File Name: C:\curso_HDL_Vanderlei\Advanced-Digital-System-Development-Using-MATLAB-C-and-VHDL\1_LINGUAGENS_HDL_E_VHDL\6_EXEMPLO_FILTRO_FIR_HDL_CODER\hdlsrc\filter_low_pass_simulink\filter_lo_ip_axi_lite.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: filter_lo_ip_axi_lite
-- Source Path: filter_lo_ip/filter_lo_ip_axi_lite
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY filter_lo_ip_axi_lite IS
...
END filter_lo_ip_axi_lite;


ARCHITECTURE rtl OF filter_lo_ip_axi_lite IS

  -- Component Declarations
  COMPONENT filter_lo_ip_addr_decoder
  ...
  COMPONENT filter_lo_ip_axi_lite_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_Lite_ARESETN               :   IN    std_logic;  -- ufix1
          AXI4_Lite_AWADDR                :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
          AXI4_Lite_AWVALID               :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : filter_lo_ip_addr_decoder
    USE ENTITY work.filter_lo_ip_addr_decoder(rtl);

  FOR ALL : filter_lo_ip_axi_lite_module
    USE ENTITY work.filter_lo_ip_axi_lite_module(rtl);
...
BEGIN
  u_filter_lo_ip_addr_decoder_inst : filter_lo_ip_addr_decoder
  ...
  u_filter_lo_ip_axi_lite_module_inst : filter_lo_ip_axi_lite_module
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
