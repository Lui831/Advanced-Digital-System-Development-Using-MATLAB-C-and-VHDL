...
ARCHITECTURE rtl OF filter_lo_ip_src_Discrete_FIR_Filter1 IS
  ...
  -- Signals
  SIGNAL initcounter                      : unsigned(1 DOWNTO 0);  -- ufix2
  SIGNAL initcompare                      : std_logic;
  SIGNAL initcompare2                     : std_logic;
...
BEGIN
  ...
  initcompare <= '1' WHEN initcounter < to_unsigned(16#2#, 2) ELSE
      '0';
  ...
  BEGIN
    IF reset = '1' THEN
      initcounter <= to_unsigned(16#0#, 2);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        IF initcompare = '1' THEN 
          IF initcounter >= to_unsigned(16#2#, 2) THEN 
            initcounter <= to_unsigned(16#0#, 2);
          ELSE 
            initcounter <= initcounter + to_unsigned(16#1#, 2);
          END IF;
        END IF;
      END IF;
    END IF;
  ...
  initcompare2 <= '1' WHEN initcounter >= to_unsigned(16#2#, 2) ELSE
      '0';
  ...
  Discrete_FIR_Filter1_out <= Discrete_FIR_Filter1_outconst0 WHEN initcompare2 = '0' ELSE
