 ...
 * File: doFilter_internal_types.h
 *
 * MATLAB Coder version            : 25.1
 * C/C++ source code generated on  : 22-Jan-2026 22:38:08
 */

#ifndef DOFILTER_INTERNAL_TYPES_H
#define DOFILTER_INTERNAL_TYPES_H

/* Include Files */
#include "doFilter_types.h"
#include "rtwtypes.h"
...
typedef struct {
  ...
  double W0_FILT_STATES[24];
  int W1_PreviousNumChannels;
  double P0_ICRTP;
  double P1_RTP1COEFF[36];
  double P2_RTP2COEFF[36];
  double P3_RTP3COEFF[13];
} dsp_SOSFilter_0;
...
#endif
/*
 * File trailer for doFilter_internal_types.h
 *
 * [EOF]
 */
