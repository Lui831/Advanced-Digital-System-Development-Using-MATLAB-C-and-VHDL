-- -------------------------------------------------------------
-- 
-- File Name: C:\ex_PINN_Matlab\codegen\prediction_v2\hdlsrc\prediction_v2_fixpt_tb_pkg.vhd
-- Created: 2025-11-17 10:57:46
-- 
...
PACKAGE prediction_v2_fixpt_tb_pkg IS
...
END prediction_v2_fixpt_tb_pkg;


PACKAGE BODY prediction_v2_fixpt_tb_pkg IS
  FUNCTION to_hex(x : IN vector_of_signed14) RETURN string IS
    VARIABLE result : STRING(1 TO 105);
    VARIABLE i      : INTEGER;
    VARIABLE j      : INTEGER;
    VARIABLE k      : INTEGER;
    VARIABLE m      : INTEGER;
