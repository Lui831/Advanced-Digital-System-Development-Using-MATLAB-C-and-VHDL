-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\thiag\OneDrive\documentos\MATLAB\codegen\hdl_IP\hdlsrc\BiquadDF2Section2.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: BiquadDF2Section2
-- Source Path: hdl_IP/dsphdl.BiquadFilter/BiquadDF2Section2
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
END BiquadDF2Section2;


ARCHITECTURE rtl OF BiquadDF2Section2 IS
...
BEGIN
  ...
  denProd2 <= to_signed(-16#32BE#, 16) * state2;
  ...
  denProd1 <= to_signed(16#36AC#, 16) * state1;
