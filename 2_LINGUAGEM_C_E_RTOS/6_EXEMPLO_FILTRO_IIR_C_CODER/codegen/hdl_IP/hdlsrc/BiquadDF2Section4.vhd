-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\thiag\OneDrive\documentos\MATLAB\codegen\hdl_IP\hdlsrc\BiquadDF2Section4.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: BiquadDF2Section4
-- Source Path: hdl_IP/dsphdl.BiquadFilter/BiquadDF2Section4
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
END BiquadDF2Section4;


ARCHITECTURE rtl OF BiquadDF2Section4 IS
...
BEGIN
  ...
  denProd2 <= to_signed(-16#0A81#, 16) * state2;
  ...
  denProd1 <= to_signed(16#2A5D#, 16) * state1;
