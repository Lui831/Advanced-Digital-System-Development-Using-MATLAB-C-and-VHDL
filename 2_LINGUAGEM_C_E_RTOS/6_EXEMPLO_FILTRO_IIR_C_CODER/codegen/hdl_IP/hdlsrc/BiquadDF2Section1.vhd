-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\thiag\OneDrive\documentos\MATLAB\codegen\hdl_IP\hdlsrc\BiquadDF2Section1.vhd
...
-- Source Path: hdl_IP/dsphdl.BiquadFilter/BiquadDF2Section1
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
BEGIN
  ...
  denProd2 <= to_signed(-16#5ED1#, 16) * state2;
  ...
  denProd1 <= to_signed(16#4427#, 16) * state1;
