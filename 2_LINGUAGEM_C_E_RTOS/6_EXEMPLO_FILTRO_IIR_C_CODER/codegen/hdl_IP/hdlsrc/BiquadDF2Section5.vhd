-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\thiag\OneDrive\documentos\MATLAB\codegen\hdl_IP\hdlsrc\BiquadDF2Section5.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: BiquadDF2Section5
-- Source Path: hdl_IP/dsphdl.BiquadFilter/BiquadDF2Section5
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
END BiquadDF2Section5;


ARCHITECTURE rtl OF BiquadDF2Section5 IS
...
BEGIN
  ...
  denProd2 <= to_signed(-16#03EF#, 16) * state2;
  ...
  denProd1 <= to_signed(16#285B#, 16) * state1;
