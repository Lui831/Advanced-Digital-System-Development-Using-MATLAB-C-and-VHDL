...
## Generated on : Mon Oct 06 14:49:24 2025
...
PRODUCT_NAME              = PID_simulink_example
MAKEFILE                  = PID_simulink_example.mk
...
CMD_FILE                  = PID_simulink_example.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
NODEBUG                   = 1
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\PID_simulink_example.exe
...
{$(START_DIR)\PID_simulink_example_ert_rtw}.c.obj:
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\PID_simulink_example_ert_rtw}.cpp.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\PID_simulink_example_ert_rtw}.cc.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\PID_simulink_example_ert_rtw}.cxx.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
