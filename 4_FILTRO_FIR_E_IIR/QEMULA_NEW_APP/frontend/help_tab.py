...
class AccordionItem(QWidget):
    ...
    def setup_ui(self, title, content):
        ...
        """)
        # Para melhor formatação de texto longo
...
class QemulaHelpApp(QMainWindow):
    def __init__(self):
        super().__init__()
        self.accordion_items = []  # Lista para armazenar referências dos accordions
...
Source: QEMULA_User_Manual.docx
        ...
        for title, content in help_items:
            ...
            self.accordion_items.append(accordion_item)  # Armazenar referência
